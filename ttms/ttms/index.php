...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/gate.jpeg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/admin.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/college.jpeg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/coll.jpg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr. B.M.Sathish</h3>
                    <hr/>
                    <h4 align="center">Principal<br/>APSCE</h4>
		</div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/isehod.jpg" class="img-rounded"/>
                    <h3 align="center">Prof. Suresh.H</h3>
                    <hr/>
                    <h4 align="center">HOD<br/>ISE Department</h4>
...
<div class="container">
    <div class="row set-row-pad">
		...
		<h4>Somanahalli,</h4>
                <h4>Bangalore-82.</h4>
                <h4><strong>Call:</strong> 987654321 </h4>
                <h4><strong>Email:</strong>apsce@gmail.com</h4>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1"
            ...
            <hr/>
            <div>
                <a href="https://www.facebook.com/apscebluru"> <img src="assets/img/Social/facebook.png" alt=""/> </a>
                <a href="https://apsce.ac.in/"> <img src="assets/img/Social/google-plus.png" alt=""/></a>
                <a href="https://twitter.com/APSCE1"> <img src="assets/img/Social/twitter.png" alt=""/></a>
            </div>
        </div>
